            ...
            foreach (XmlElement x in xmldoc.ChildNodes[1])
            {
                ...
                foreach (XmlElement z in x.SelectNodes("item"))
                {
                    ...
                    if (i != -1)
                    {
                        ...
                        M1[Estados.IndexOf(z.FirstChild.InnerText), i] = M1[Estados.IndexOf(z.FirstChild.InnerText), i] + 1;
                ...
                float[,] MF = new float[Estados.Count, Estados.Count];
                float[,] MF2 = new float[1, Estados.Count];
                MF2[0, 0] = 1;
                ...
                MF2 = Matriz.MultiplicarMatrizes(MF2, MF, 1, Estados.Count, Estados.Count, Estados.Count);
